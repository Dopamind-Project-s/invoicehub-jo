            ...
            <div class="container">
               <div class="row g-5 mb-5">
                  ...
                  <div class="col-6 col-md-2 fcol">
                     ...
                     <a href="mailto:{{ data_get($settings ?? [], 'contact.email', 'musab.m.alzoubii@gmail.com') }}">البريد الإلكتروني</a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.linkedin', 'https://www.linkedin.com/in/musabmalzoubi/') }}">LinkedIn</a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.github', 'https://github.com/MusabAlzoubi') }}">GitHub</a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.facebook', 'https://www.facebook.com/profile.php?id=61562391058375') }}">Facebook</a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.instagram', 'https://www.instagram.com/musab_digitransform') }}">Instagram</a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.instagram_qahwa', 'https://www.instagram.com/qahwa.dopamind') }}">قهوة دوبامايند</a>
                  </div>
               </div>
               <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 pt-4" style="border-top:1px solid var(--bd)">
                  ...
                  <div class="d-flex gap-2">
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.github', 'https://github.com/MusabAlzoubi') }}" class="sico" aria-label="GitHub"><i class="fa-brands fa-github"></i></a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.linkedin', 'https://www.linkedin.com/in/musabmalzoubi/') }}" class="sico" aria-label="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.facebook', 'https://www.facebook.com/profile.php?id=61562391058375') }}" class="sico" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
                     <a target="_blank" rel="noopener" href="{{ data_get($settings ?? [], 'social.instagram', 'https://www.instagram.com/musab_digitransform') }}" class="sico" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                  </div>
               </div>
            </div>
         </footer>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="lofc">
         ...
         <div class="offcanvas-body p-4">
            <div class="mb-4">
               ...
               <h3 class="mb-2">ادخل إلى لوحة تحكم InvoSync Jo</h3>
               <p class="mb-0" style="color:var(--tx3);font-size:.9rem">استخدم بريدك وكلمة المرور للوصول إلى مساحة العمل.</p>
            </div>
            <!-- Login only -->
            <div id="fLogin">
               ...
               <form method="POST" action="{{ route('login') }}" class="d-grid gap-3">
                  @csrf
                  <div>
                     <label class="olbl" for="landingLoginEmail"><i class="fa-regular fa-envelope me-1"></i>البريد الإلكتروني</label>
                  ...
                  <div>
                     <label class="olbl" for="landingLoginPassword"><i class="fa-solid fa-lock me-1"></i>كلمة المرور</label>
                  ...
                  <div class="d-flex align-items-center justify-content-between gap-3 mb-2">
                     ...
                     @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" style="font-size:.8rem;color:var(--pur)">نسيت كلمة المرور؟</a>
                     @endif
                  </div>
                  <button type="submit" class="bgrd btn w-100 py-3 fw-semibold fs-6" id="loginBtn">دخول <i class="fa-solid fa-arrow-left ms-1 fa-sm"></i></button>
               </form>
            </div>
         </div>
      </div>
