<footer id="foot">
    <div class="container">
        <div class="row g-5 mb-5">
            ...
            <div class="col-6 col-md-2 fcol"><h5>المنتج</h5><a href="{{ url('/#features') }}">المزايا</a><a href="{{ url('/#integrations') }}">التكاملات</a><a href="{{ url('/#pricing') }}">الباقات</a><a href="{{ url('/#faq') }}">الأسئلة الشائعة</a><a href="{{ route('blogs.index') }}">المدونة</a></div>
