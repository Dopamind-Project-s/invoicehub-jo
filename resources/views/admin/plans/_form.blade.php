...
<div class="row g-3" dir="rtl">
    ...
    <div class="col-md-4"><label class="form-label">الترتيب</label><input name="sort_order" type="number" min="0" class="form-control" value="{{ old('sort_order', $plan->sort_order ?? 0) }}"></div>
