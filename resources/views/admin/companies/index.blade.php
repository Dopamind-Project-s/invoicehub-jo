...
@section('content')
<x-layout.page-header title="إدارة الشركات" subtitle="إنشاء وتعديل وتفعيل وتعليق شركات النظام.">
    <x-slot:actions><a class="btn btn-primary" href="{{ route('admin.companies.create') }}">شركة جديدة</a></x-slot:actions>
</x-layout.page-header>
<div class="card"><div class="table-responsive"><table class="table mb-0 align-middle">
    <tr><th>الشركة</th><th>الرقم الضريبي</th><th>الهاتف</th><th>الحالة</th><th>الميزات</th><th></th></tr>
