    ...
    <div class="container position-relative" style="z-index:2">
        <div class="text-center">
            ...
            <div class="d-flex align-items-center justify-content-center gap-3 flex-wrap">
                <a href="{{ route('register') }}" class="bgrd btn px-4 py-3 fs-6">{{ $settings->get('cta.primary_text_ar', 'ابدأ إدارة فواتير منشأتك') }}</a>
                <a href="https://wa.me/962{{ ltrim($settings->get('contact.whatsapp', '0776079926'), '0') }}" class="boc btn px-4 py-3 fs-6">{{ $settings->get('cta.secondary_text_ar', 'تواصل عبر واتساب') }}</a>
            </div>
        </div>
