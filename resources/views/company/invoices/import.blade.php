...
@section('content')
<x-layout.page-header title="استيراد فواتير جوفوتارا" subtitle="أساس عملي لاستيراد فواتير صادرة سابقاً عبر ملف JSON أو CSV بدون اختلاق واجهة سحب رسمية.">
...
<form method="post" enctype="multipart/form-data" action="{{ route('company.invoices.import.store', $company) }}" class="card card-body mb-3">
    ...
    <button class="btn btn-primary mt-3">استيراد</button>
</form>
