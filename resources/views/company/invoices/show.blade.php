...
<div class="card card-body mt-3"><h2 class="h5">تجربة الفاتورة</h2><p class="text-muted mb-2">القالب والهوية يتم تحميلهما من إعدادات الشركة. روابط المشاركة الحالية: {{ $invoice->shares()->count() }}</p><div class="placeholder">QR / UUID placeholder فقط — لا يوجد توليد جديد هنا.</div></div>
