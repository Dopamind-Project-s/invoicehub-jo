...
@endphp
<style>
.invoice-form-shell{--invoice-primary:{{ $primary }};--invoice-secondary:{{ $secondary }};border:1px solid #e5eef4;border-radius:24px;overflow:hidden;box-shadow:0 16px 36px rgba(15,23,42,.07)}.invoice-form-banner{background:linear-gradient(135deg,var(--invoice-primary),var(--invoice-secondary));color:#fff;padding:22px 24px}.invoice-form-body{padding:24px}.form-section{border:1px solid #e8f0f5;border-radius:18px;padding:18px;background:#fff;margin-bottom:18px}.form-section-title{display:flex;align-items:center;gap:8px;font-weight:800;margin-bottom:15px;color:#172033}.invoice-form-shell .form-control,.invoice-form-shell .form-select{border-radius:14px;border-color:#dbe7ee}.invoice-form-shell .form-control:focus,.invoice-form-shell .form-select:focus{border-color:var(--invoice-primary);box-shadow:0 0 0 .2rem rgba(0,169,196,.12)}.items-table th{background:#f7fbfc;color:#475569}.form-actions{background:#f8fbfc;border-top:1px solid #e5eef4;padding:18px 24px}.form-actions .btn{border-radius:999px}.template-chip{display:inline-flex;align-items:center;gap:6px;background:#f1f9fb;color:#0f6170;border:1px solid #d7eef3;border-radius:999px;padding:7px 12px}
</style>

<div class="invoice-form-shell" dir="rtl">
