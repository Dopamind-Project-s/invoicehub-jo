@extends('layouts.app')
@section('title', 'مستخدمو المنشأة')
@section('content')
<x-layout.page-header :title="'مستخدمو '.$company->name_ar" subtitle="إدارة مستخدمي المنشأة وأدوارهم."><x-slot:actions><a class="btn btn-primary" href="{{ route('company.users.create', $company) }}">مستخدم جديد</a></x-slot:actions></x-layout.page-header>
